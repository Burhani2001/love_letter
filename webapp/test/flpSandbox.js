		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#deososoftllresultsresultsbyweekfreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"deososoftllresultsresultsbyweekfreestyle-display": {
								"semanticObject": "deososoftllresultsresultsbyweekfreestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.ososoft.llresults.resultsbyweekfreestyle",
									"url": sap.ui.require.toUrl("de/ososoft/llresults/resultsbyweekfreestyle")
								}
							}
						}
					}
